...
public interface ICebaChargeLogService {
	...
	List<CebaChargeLogModel> getCheckTrace(MyLog myLog,String date,String hostCheckState,String cebaCheckState) throws SysTradeExecuteException;
	
	void updateCheck(@Valid CebaChargeLogModel record) throws SysTradeExecuteException;
	
	CebaChargeLogModel queryLogByPk(MyLog myLog, Integer sysDate, Integer sysTraceno) throws SysTradeExecuteException;
	...
	String getHostCheckNum(String date, String capResult) throws SysTradeExecuteException;
	
	String getCebaCheckNum(String date, String capResult) throws SysTradeExecuteException;
	
	String getCheckSuccNum(String date) throws SysTradeExecuteException;
	
	String getTotalCheckNum(String date) throws SysTradeExecuteException;
	
	String getCheckSuccAmt(String date) throws SysTradeExecuteException;
	
	void updateHostRefunde(@Valid CebaChargeLogModel record) throws SysTradeExecuteException;

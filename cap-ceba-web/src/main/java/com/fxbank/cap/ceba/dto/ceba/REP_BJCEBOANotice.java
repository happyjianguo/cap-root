...
public class REP_BJCEBOANotice extends DTO_BASE {

	private static final long serialVersionUID = -3475387829134355059L;
	...
	public void chanFixPack(String pack) {
		REP_BJCEBOANotice res = (REP_BJCEBOANotice) CebaXmlUtil.xmlToObject(this.getClass(), pack);

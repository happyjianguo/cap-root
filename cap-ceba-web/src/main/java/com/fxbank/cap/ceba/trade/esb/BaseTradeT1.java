...
public abstract class BaseTradeT1 {
	...
	* @throws 
	*/
	public abstract MODEL_BASE othCharge(DataTransObject dto) throws SysTradeExecuteException;
	...
	* @throws 
	*/
	public abstract void updateOthSuccess(DataTransObject dto, MODEL_BASE model) throws SysTradeExecuteException;
	...
	* @throws 
	*/
	public abstract DataTransObject backMsg(DataTransObject dto,MODEL_BASE model) throws SysTradeExecuteException;

...
@Component
@EnableScheduling
public class BatfCollTask {
	private static Logger logger = LoggerFactory.getLogger(BatfCollTask.class);
	...
	public MethodInvokingJobDetailFactoryBean accMstTracePushJobDetail(BatfCollTask task) {// ScheduleTask为需要执行的任务
